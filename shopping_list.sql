...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2024 at 03:16 AM
...
INSERT INTO `shopping_items` (`id`, `user_id`, `item_name`, `quantity`) VALUES
(1, 1, 'banana', 1),
(2, 1, 'apple', 2);
...
(1, 'njo', '$2y$10$WAOKkVmogGeDiNJthfeiUu6cku9s3Pc.gUtyNPmiNl6eH9C/5biAK');
